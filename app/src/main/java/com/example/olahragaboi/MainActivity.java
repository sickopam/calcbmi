package com.example.olahragaboi;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void increaseWeight(View view) {
        if (Integer.parseInt(weight.getText().toString()) > 0) {
            int age_value = Integer.parseInt(weight.getText().toString()) + 1;
            weight.setText(String.valueOf(age_value));
        }
    }
    ...
    private void showBMI(int bmi) {
        ...
        if (bmi < 18.5) {
            showCustomDialog(R.drawable.underweight, "Underweight", "Increase calorie intake.");
        } else if (bmi > 18.5 && bmi < 24.9) {
            showCustomDialog(R.drawable.normal, "Normal Weight", "Maintain good diet.");
        } else {
            showCustomDialog(R.drawable.overweight, "Overweight", "You should exercise.");
        }
